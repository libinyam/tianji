...
const MODULES: ModuleDef[] = [
  ...
  },
  {
    ...
    icon: Lightbulb,
    title: "灵感广场",
    desc: "项目创意与研究思路的交流空间。把专业知识做成可展示的作品，让每一个念头都可能落地成 Demo。",
  },
  {
    index: "04",
    to: "/workshop",
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-mist-500">{m.index}</span>
              </div>
              <h3 className="mt-4 heading-display text-lg text-parchment-50">{m.title}</h3>
              <p className="mt-2 flex-1 text-sm leading-relaxed text-mist-400">{m.desc}</p>
